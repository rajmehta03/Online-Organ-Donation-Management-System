...
import DonorRequests from './DonorRequests/DonorRequests';
import HospitalLogin from './HospitalLogin/HospitalLogin';
import HospitalSignup from './HospitalSignup/HospitalSignup';
import OrganInventory from './OrganInventory/OrganInventory';
...
import NeedOrgan from './NeedOrgan/NeedOrgan';
  ...
  render() {
    return (
      <>
        ...
        <Route path="/need-organ" exact strict component={NeedOrgan} />
        <Route path="/donor-requests" exact strict component={DonorRequests} />
        <Route path="/admin" exact strict component={Admin} />
        <Route path="/admin/need-organ" exact strict component={AdminNeedBlood} />
        ...
        <Route path="/admin/update-status/:id" exact strict component={UpdateStatus} />
        ...
        <Route path="/hospital-login" exact strict component={HospitalLogin} />
        <Route path="/hospital-signup" exact strict component={HospitalSignup} />
        <Route path="/organ-inventory" exact strict component={OrganInventory} />
        <Route path="/hospital-requests" exact strict component={HospitalRequests} />
        <Route path="/my-requests" exact strict component={MyRequests} />
      </>
    );
  }
