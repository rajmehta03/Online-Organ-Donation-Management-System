...
public class BloodRecipientObjectMapper {
    ...
    public BloodRecipient map(BloodRecipientDTO bloodRecipientDTO) {
        ...
        if (bloodRecipientDTO.getRequiredOrganType() != null && !bloodRecipientDTO.getRequiredOrganType().isEmpty()) {
            bloodRecipient.setRequiredOrganType(OrganType.valueOf(bloodRecipientDTO.getRequiredOrganType()));
        }
        bloodRecipient.setOrganQuantityRequired(bloodRecipientDTO.getOrganQuantityRequired());
        bloodRecipient.setRequesterHospitalId(bloodRecipientDTO.getRequesterHospitalId());
